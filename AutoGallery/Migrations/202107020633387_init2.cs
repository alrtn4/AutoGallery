    ...
    public partial class init2 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.ArticleComments", t => t.Comment_Id)
                .Index(t => t.ParentId)
                .Index(t => t.ArticleId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ArticleComments", "Comment_Id", "dbo.ArticleComments");
            ...
            DropIndex("dbo.ArticleComments", new[] { "Comment_Id" });
